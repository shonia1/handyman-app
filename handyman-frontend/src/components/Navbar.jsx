        ...
        <div className="hidden md:flex items-center gap-4">
          {user ? (
            <>
              ...
              <Link to="/profile" className="bg-indigo-500 hover:bg-indigo-400 text-white px-4 py-2 rounded-lg font-semibold transition">
                👤 პროფილი
              </Link>
              ...
              {user.role === "client" && (
                <Link to="/create" className="bg-white text-indigo-700 px-5 py-2 rounded-lg font-semibold hover:bg-gray-100 transition">+ ახალი განცხადება</Link>
              )}
          ...
          {user ? (
            <>
              ...
              <Link
                ...
                className="block w-full bg-indigo-500 text-white text-center px-5 py-2 rounded-lg font-semibold hover:bg-indigo-600 transition"
              >
                👤 პროფილი
              </Link>

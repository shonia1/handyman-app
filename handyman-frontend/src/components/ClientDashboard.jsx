  ...
  if (myJobs.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-6">
        ...
        <p className="text-gray-500 max-w-md mb-8">იყავით პირველი! განათავსეთ შეკვეთა და ხელოსანი თვითონ დაგიკავშირდებათ.</p>
        <Link to="/create" className="px-8 py-3 bg-blue-600 text-white font-bold rounded-full shadow-lg hover:bg-blue-700 transition-all hover:scale-105">+ ახალი შეკვეთის დამატება</Link>
      </div>
    );
  }
